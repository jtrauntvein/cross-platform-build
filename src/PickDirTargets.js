 ...
 * @param {function<fs.Dirent>} pick Specifies the callback function that will be called for each directory entry in the working directory.
 * It is up to this function to add any targets that may be associated with the directory entry.
 * @param {object={}} options Specifies the options that should be registered for all added targets.
 */
/**
